...
const AboutCardInfoData=[
  {
    img:{
      desktop:images.aboutTalent,
      tablet:imagesTablet.aboutTalent,
      mobile:imagesMobile.aboutTalent
    },
  ...
  {
    img:{
      desktop:images.aboutDeal,
      tablet:imagesTablet.aboutDeal,
      mobile:imagesMobile.aboutDeal
    },
    title:'The real deal',
...
const AboutHeaderData = {
  ...
  image:{
    desktop:images.aboutHero,
    tablet:imagesTablet.aboutHero,
    mobile:imagesMobile.aboutMobile
  }
}
